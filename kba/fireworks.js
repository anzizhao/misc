var Fireworks = function(){
    ...
    self.init = function(){ 
        ...
        self.canvas.width = self.cw = document.documentElement.clientWidth;
        self.canvas.height = self.ch = document.documentElement.clientHeight; 
    ...
    Particle.prototype.draw = function(){
        ...
        self.ctx.strokeStyle = 'rgba(119,57,16,.5)' //3d250c 
        self.ctx.stroke();              
  ...
  self.updateDelta = function(){
    ...
    self.canvasLoop = function(){
        if( self.status === 0 ) {
            //console.log('canvasLoop stop');
            // 停止跳出
            return 
        }
        //console.log('canvasLoop run');
    ...
    self.start = function(){
        self.status = 1; //0 为stop,  1 为start  
        self.canvasLoop();
    }

    self.stop = function(){
        self.status = 0; //0 为stop,  1 为start  
    }
    ...
    while(initialLaunchCount--){
        setTimeout(function(){
            ...
            self.fireworks.push(new Firework(self.cw/2, self.ch/2, self.cw/2, self.ch/2-50));
